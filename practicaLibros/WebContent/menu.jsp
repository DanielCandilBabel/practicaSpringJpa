...
<body>
	...
	<div class="text-center" style="padding: 50px 0">
		<div class="logo">ELEGIR TEMA</div>
		<!-- Main Form -->
		<div class="login-form-1">
			<form id="login-form" action="listado" class="text-left">
				<div class="form-group col-md-4">
					<label for="inputState" name="tema">Temas</label>
					<select id="inputState" name="tema" class="form-control">
					<option name="tema" selected>Todos</option>
					...
					<button type="submit" href="" class="login-button"><i class="fa fa-chevron-right"></i>></button>
				</div>
			</form>
			<div class="etc-login-form">
				<p><a href="toLogin">EXIT</a></p>
			</div>
		</div>
		<!-- end:Main Form -->
	</div>
